...
const flatTypes = computed(() => Object.keys(flatTypeAndModelInfo) )

const flatModel = computed(() => flatTypeAndModelInfo[listingData.value.flatType])
...
const flatTypeAndModelInfo = {"1 ROOM": ["Improved"], "2 ROOM": ["Improved", "Standard", "Model A", "Premium Apartment", "DBSS", "2-room"], "3 ROOM": ["New Generation", "Improved", "Simplified", "Model A", "Standard", "Premium Apartment", "DBSS", "Terrace"], "4 ROOM": ["New Generation", "DBSS", "Simplified", "Improved", "Model A", "Premium Apartment", "Standard", "Type S1", "Model A2", "Adjoined flat", "Terrace", "Premium Apartment Loft"], "5 ROOM": ["Standard", "Improved", "DBSS", "Adjoined flat", "Model A", "Premium Apartment", "Model A-Maisonette", "Type S2", "Improved-Maisonette", "Premium Apartment Loft", "3Gen"], "EXECUTIVE": ["Apartment", "Maisonette", "Premium Apartment", "Adjoined flat", "Premium Maisonette"], "MULTI-GENERATION": ["Multi Generation"]}
